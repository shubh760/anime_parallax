...
import 'package:parallax/utils/map_api.dart';
...
class _LocationTrackingState extends State<LocationTracking> {
  ...
  void showLocationPins() {
    ...
    _marker.add(Marker(
      ...
      infoWindow: InfoWindow(title: "${sourceposition.latitude} , ${sourceposition.longitude}"),
  ...
  void addLocation(LatLng pos){
    setState(() {
      ...
      infoWindow: InfoWindow(title: "${pos.latitude} , ${pos.longitude}"),
      position: pos,
    ));
    });
  }
